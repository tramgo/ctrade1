...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `E1006_core0.50_active0.50_top10_r30_breadth_adv_50` | `BreadthAdvFrac_1 >= 0.50` | `20.16%` | `17.12%` | `7 / 10` | `-7.49%` | `-11.44%` | `90` | `53` | `6.68%` | `promoted_candidate` |

Other promotion-gate passers:

| Candidate | Mean Ann. | Folds Beating Buy-Hold | Verdict |
|---|---:|---:|---|
| `E1006_core0.60_active0.40_top10_r30_breadth_adv_50` | `19.57%` | `7 / 10` | `promoted_candidate` |
| `E1006_core0.00_active1.00_top5_r15_breadth_adv_50` | `19.53%` | `7 / 10` | `promoted_candidate` |
| `E1006_core0.80_active0.20_top5_r30_trend_score_positive` | `18.73%` | `7 / 10` | `promoted_candidate` |

## Decision

Advance `TB13_CoreActiveTiltPortfolioRank` as the next OHLCV-only equity research candidate. The preferred candidate is `E1006_core0.50_active0.50_top10_r30_breadth_adv_50` because it uses the simplest predeclared breadth gate and passes the target buy-hold gate:
