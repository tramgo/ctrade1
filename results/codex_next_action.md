...
TB18 is no longer data-blocked, but the no-order backtest does not promote an earnings overlay. TB15 has too few overlapping earnings vetoes and the veto slightly lowers mean return; TB11 cannot be historically tested against the current NSE earnings file because the selected TB11 backtest window ends before the fetched earnings window begins.

Next action:

Do not apply TB18 earnings vetoes to live or paper sizing yet. Backfill older earnings history or collect repeated paper observations before reconsidering the overlay.
