...
powershell -NoProfile -ExecutionPolicy Bypass -Command "$log = [System.IO.Path]::GetFullPath('%LOG_FILE%'); & python -B ssell1.py --mode '%MODE%' 2>&1 | Tee-Object -FilePath $log; exit $LASTEXITCODE"
